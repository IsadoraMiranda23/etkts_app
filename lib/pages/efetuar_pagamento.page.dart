                ...
                content: Column(
                  ...
                  children: [
                    ...
                    Button(
                      ...
                      borderColor: MyColors.cinzaMedioEscuro,
                      width: 78,
                      height: 36,
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: ItemVendaComponente(onTotalChanged: atualizarValorTotal),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
            ...
            Padding(
              ...
              child: Divider(color: MyColors.verde, height: 2, thickness: 2),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
